...
export const rangeOffset = (range: Range, offset: number): Range => {
    const [a, b] = range;
    return [a + offset, b + offset];
}
export const rangesOffset = (ranges: Range[], offset: number): Range[] => {
    return ranges.map(r => rangeOffset(r, offset));
}
